...
public class XXTEA
{
	private static string _defaultKeyString = "3gu";
	private static Byte[] _defaultKey;
	private static Byte[] defaultKey {
		get {
			if(_defaultKey == null) {
				_defaultKey = System.Text.Encoding.Default.GetBytes ( _defaultKeyString );
			}
			return _defaultKey;
		}
	}

	private static Byte[] customKey = null;
	public static void SetKeyString( string key ){
		customKey = System.Text.Encoding.Default.GetBytes( key );
	}
