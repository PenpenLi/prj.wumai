...
namespace LuaFramework {
    public class Util {
        ...
        public static string md5Byte(byte[] byteArray){
        ...
        public static string DataPath {
            get {
                string game = AppConst.AppPath.ToLower();
                if (Application.isMobilePlatform) {
                    return Application.persistentDataPath + "/" + game + "/";
                }
                //问题不要搞复杂了
                // if (AppConst.DebugMode) {
                //     return AppConst.PublishAssetDir;
                // }
        ...
        public static string GetRelativePath() {
            if (Application.isEditor)
                return "file://" + System.Environment.CurrentDirectory.Replace("\\", "/") + "/Assets/" + AppConst.PublishAssetDir + "/";
            else if (Application.isMobilePlatform || Application.isConsolePlatform)
                return "file:///" + DataPath;
            else // For standalone player.
                return "file://" + AppConst.PublishAssetsPath;
        }
        ...
        /// 应用程序内容路径
        /// </summary>
        public static string AppContentPath(bool async = true) {
            ...
            switch (Application.platform) {
                ...
                default:
                    if(async){
                        path = "file://" + AppConst.StreamingAssetsPath; 
                    }else{
                        path = AppConst.StreamingAssetsPath;
                    }
        ...
        public static int CheckRuntimeFile() {
            ...
            string streamDir = AppConst.PublishAssetsPath;
        ...
        public static LuaBehaviour AddLuaScript(GameObject go, LuaTable luaTable)
        {
            LuaBehaviour obj = go.AddComponent<LuaBehaviour>();
            obj.OnInit(luaTable);
            return obj;
        }
    }
