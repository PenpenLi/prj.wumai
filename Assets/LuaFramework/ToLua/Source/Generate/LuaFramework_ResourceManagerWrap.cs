...
public class LuaFramework_ResourceManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("LoadLuaPrefab", LoadLuaPrefab);
	...
	static int LoadPrefab(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(LuaFramework.ResourceManager), typeof(string), typeof(string[]), typeof(System.Action<UnityEngine.Object[]>)))
			{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int LoadLuaPrefab(IntPtr L)
	{
		try
		{
			...
			obj.LoadLuaPrefab(arg0, arg1, arg2);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int ResourceLoad(IntPtr L)
	{
		try
		{
			...
			object o = LuaFramework.ResourceManager.ResourceLoad(arg0);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
