...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(UIEventListener.VoidPointerDelegate), UIEventListener_VoidPointerDelegate);
		dict.Add(typeof(UIEventListener.VoidBaseDelegate), UIEventListener_VoidBaseDelegate);
		...
		dict.Add(typeof(LuaFramework.AssetBundleManager.OverrideBaseDownloadingURLDelegate), LuaFramework_AssetBundleManager_OverrideBaseDownloadingURLDelegate);
		dict.Add(typeof(System.Action<UnityEngine.Object>), System_Action_UnityEngine_Object);
		dict.Add(typeof(System.Func<string,bool>), System_Func_string_bool);
	...
	class UIEventListener_VoidPointerDelegate_Event : LuaDelegate
	{
		public UIEventListener_VoidPointerDelegate_Event(LuaFunction func) : base(func) { }
		public UIEventListener_VoidPointerDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate UIEventListener_VoidPointerDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UIEventListener.VoidPointerDelegate fn = delegate(UnityEngine.GameObject param0, UnityEngine.EventSystems.PointerEventData param1) { };
			return fn;
		}

		if(!flag)
		{
			UIEventListener.VoidPointerDelegate d = (new UIEventListener_VoidPointerDelegate_Event(func)).Call;
			return d;
		}
		else
		{
			UIEventListener.VoidPointerDelegate d = (new UIEventListener_VoidPointerDelegate_Event(func, self)).CallWithSelf;
			return d;
		}
	}

	class UIEventListener_VoidBaseDelegate_Event : LuaDelegate
	{
		public UIEventListener_VoidBaseDelegate_Event(LuaFunction func) : base(func) { }
		public UIEventListener_VoidBaseDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate UIEventListener_VoidBaseDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UIEventListener.VoidBaseDelegate fn = delegate(UnityEngine.GameObject param0, UnityEngine.EventSystems.BaseEventData param1) { };
			return fn;
		}

		if(!flag)
		{
			UIEventListener.VoidBaseDelegate d = (new UIEventListener_VoidBaseDelegate_Event(func)).Call;
			return d;
		}
		else
		{
			UIEventListener.VoidBaseDelegate d = (new UIEventListener_VoidBaseDelegate_Event(func, self)).CallWithSelf;
			return d;
		}
	}
	...
	class LuaFramework_AssetBundleManager_OverrideBaseDownloadingURLDelegate_Event : LuaDelegate
	{
		public LuaFramework_AssetBundleManager_OverrideBaseDownloadingURLDelegate_Event(LuaFunction func) : base(func) { }
		public LuaFramework_AssetBundleManager_OverrideBaseDownloadingURLDelegate_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public static Delegate LuaFramework_AssetBundleManager_OverrideBaseDownloadingURLDelegate(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			LuaFramework.AssetBundleManager.OverrideBaseDownloadingURLDelegate fn = delegate(string param0) { return null; };
			return fn;
		}

		if(!flag)
		{
			LuaFramework.AssetBundleManager.OverrideBaseDownloadingURLDelegate d = (new LuaFramework_AssetBundleManager_OverrideBaseDownloadingURLDelegate_Event(func)).Call;
			return d;
		}
		else
		{
			LuaFramework.AssetBundleManager.OverrideBaseDownloadingURLDelegate d = (new LuaFramework_AssetBundleManager_OverrideBaseDownloadingURLDelegate_Event(func, self)).CallWithSelf;
			return d;
		}
	}
	...
	public static Delegate System_Func_string_bool(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
		...
		if(!flag)
		{
			System.Func<string,bool> d = (new System_Func_string_bool_Event(func)).Call;
			return d;
		}
		else
		{
			System.Func<string,bool> d = (new System_Func_string_bool_Event(func, self)).CallWithSelf;
			return d;
		}
	}
	...
	public static Delegate System_Action_UnityEngine_GameObject_int(LuaFunction func, LuaTable self, bool flag)
	{
		...
		{
			System.Action<UnityEngine.GameObject,int> d = (new System_Action_UnityEngine_GameObject_int_Event(func, self)).CallWithSelf;
			return d;
		}
	}
