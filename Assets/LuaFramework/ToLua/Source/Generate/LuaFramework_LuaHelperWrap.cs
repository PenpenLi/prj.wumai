...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetAssetBundleManager", GetAssetBundleManager);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetAssetBundleManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			LuaFramework.AssetBundleManager o = LuaFramework.LuaHelper.GetAssetBundleManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
